...
public class Main {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        File file = new File("e_so_many_books.txt");
        ...
        while (readingFile)
        {
            if (!in.hasNext()) {
                ...
                String fourthLine = in.nextLine();   //countLine = 3
        ...
        libraryObjs = libraryObjs.stream()
                .sorted(Comparator.comparingLong(Library::getEffectiveShippedBooksPerScanningTime))
        ...
        PrintWriter writeSolution = new PrintWriter("e_byShip.txt");
